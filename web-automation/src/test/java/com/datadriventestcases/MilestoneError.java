...
public class MilestoneError extends BaseTest {
	...
	public void milestoneErrorAndBrokenLinks(Map<String,String> data)  {
		if (data.get("Active").equalsIgnoreCase("y") || data.get("Active").equalsIgnoreCase("yes")){
			...
			objLoginPageView.navigateToMilestonepage();
			objBrokenLinkAndImageView.verifyAllBrokenLinks();
			objBrokenLinkAndImageView.verifyAllBrokenImages();
